...
const Rank:React.FC<Props> = ({ rankRef, sortBy, setSortBy, setSelectorLoad, passportDataRef }) => {
  ...
  return (
    ...
    <Head>
      <title>GlobeReach - Rankings</title>
